"""ACE prompts preserved from the upstream ACE repository.

These are intentionally kept as algorithm-facing assets in the example
package so the prompt designs remain easy to inspect and modify.
"""
